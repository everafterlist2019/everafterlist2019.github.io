...
/* harmony import */ var _ng_stack_contenteditable__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @ng-stack/contenteditable */ "./node_modules/@ng-stack/contenteditable/fesm5/ng-stack-contenteditable.js");
...
var ContenteditableModelDirective = /** @class */ (function () {
    ...
    ContenteditableModelDirective.prototype.onBlur = function () {
...
var EmployeeListComponent = /** @class */ (function () {
    function EmployeeListComponent(service, firestore, toastr, afs) {
    ...
    EmployeeListComponent.prototype.addTask = function (isLabel, arr, i) {
    ...
    EmployeeListComponent.prototype.deleteTask = function (task, arr, i, x) {
        //IF DELETING TASK
        if (task !== null) {
            this.docRef.update({
    ...
    EmployeeListComponent.prototype.editTask = function (arr) {
        this.firestore.doc('tasks/master').update({ tasks: arr });
    };
    EmployeeListComponent.prototype.deleteFromUserList = function (masterArr, userArr, userTask, user) {
        if (user == 'user1') {
            this.docRef.update({
    ...
    //user: 'user1' or 'user2'
    EmployeeListComponent.prototype.fromUserEditMaster = function (masterArr, userArr, userTask, user) {
    ...
    EmployeeListComponent.prototype.fromMasterEditUser = function (masterArr, taskIndex, subtaskIndex, user) {
    ...
    EmployeeListComponent.prototype.onCheckSubTask = function (emp, subDone, i) {
        this.firestore.doc('employees/' + emp.id).update(emp);
    };
    //PURPOSE: to delete subtask of item
    //Given list/employee object and index of subtask array, delete item at index
    EmployeeListComponent.prototype.deleteSubTask = function (emp, i) {
        emp.subTasks.splice(i, 1);
        this.firestore.doc('employees/' + emp.id).update(emp);
    };
    EmployeeListComponent.prototype.onEdit = function (emp, sub, i) {
    ...
    EmployeeListComponent.prototype.updateOrder = function () {
    ...
    EmployeeListComponent.prototype.reorderList = function (event, arr, subArr, list) {
...
var SortByPipe = /** @class */ (function () {
    ...
    SortByPipe.prototype.transform = function (value, column, order) {
...
var SortableDirective = /** @class */ (function () {
    ...
    SortableDirective.prototype.ngAfterViewInit = function () {
        ...
        this.sortable.on('sortable:stop', function (e) { return _this.handleStop(e); });
    };
    SortableDirective.prototype.handleStop = function (e) {
...
module.exports = __webpack_require__(/*! /Users/shariafuso/Desktop/angular/everafterlist2019.github.io-4.io/src/main.ts */"./src/main.ts");
